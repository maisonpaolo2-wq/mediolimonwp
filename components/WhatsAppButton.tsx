...
/** CTA directo: WhatsApp si existe, si no, mensaje por Instagram */
export const directHref = hasWhatsapp ? whatsappHref : site.instagramUrl
export const directLabel = hasWhatsapp ? 'Escribir por WhatsApp' : 'Escribir por Instagram'
...
// Se oculta mientras no haya número: un wa.me vacío es un enlace roto.
export default function WhatsAppButton() {
  if (!hasWhatsapp) return null
  return (
    <a href={whatsappHref} target="_blank" rel="noopener noreferrer" className="wa" aria-label="Escribir a Medio Limón por WhatsApp">
      <WhatsAppIcon />
    </a>
  )
}
